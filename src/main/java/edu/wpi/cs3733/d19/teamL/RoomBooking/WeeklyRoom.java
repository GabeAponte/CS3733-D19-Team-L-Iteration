    ...
    public WeeklyRoom(LocalTime startTime, LocalTime endTime, LocalDate theDate, String classroomName){
        ...
        switch(dayOfWeek){
            case "SUNDAY":
                ...
                break;
            case "MONDAY":
                sDate = weekDay.minusDays(1).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(1).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isSunday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isMonday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.plusDays(1).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.plusDays(1).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isTuesday = ra.checkRoom(sDate, eDate,classroomName);
                ...
                break;
            case "TUESDAY":
                sDate = weekDay.minusDays(2).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(2).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isSunday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.minusDays(1).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(1).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isMonday = ra.checkRoom(sDate, eDate,classroomName);
                ...
                break;
            case "WEDNESDAY":
                sDate = weekDay.minusDays(3).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(3).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isSunday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.minusDays(2).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(2).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isMonday = ra.checkRoom(sDate, eDate,classroomName);
                ...
                break;
            case "THURSDAY":
                sDate = weekDay.minusDays(4).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(4).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isSunday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.minusDays(3).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(3).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isMonday = ra.checkRoom(sDate, eDate,classroomName);
                ...
                break;
            case "FRIDAY":
                sDate = weekDay.minusDays(5).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(5).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isSunday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.minusDays(4).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(4).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isMonday = ra.checkRoom(sDate, eDate,classroomName);
                ...
                break;
            case "SATURDAY":
                sDate = weekDay.minusDays(6).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(6).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isSunday = ra.checkRoom(sDate, eDate,classroomName);
                sDate = weekDay.minusDays(5).toString() + "T" + String.format("%2d",startTime.getHour()) + ":" + startTime.getMinute() + ":00";
                eDate = weekDay.minusDays(5).toString() + "T" + String.format("%2d",endTime.getHour()) + ":" + endTime.getMinute() + ":00";
                isMonday = ra.checkRoom(sDate, eDate,classroomName);
