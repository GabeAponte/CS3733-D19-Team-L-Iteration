...
import edu.wpi.cs3733.d19.teamL.Object.ServiceRequestTable;

public class FloristDeliveryAccess extends DBAccess{
    ...
    public void deleteRecords() {
        String sql = "Delete from floristDeliveryRequest;";
...
*/
    ...
    public TreeItem<ServiceRequestTable> getFloristRequests(int getNum){
        ...
        String sql = "SELECT * FROM floristDeliveryRequest where requestID is not NULL and fulfilled = 0";
        int count = 0;
    ...
    public int countRecords() {
        String sql = "select COUNT(*) from floristDeliveryRequest where requestID is not null and fulfilled = false";
        try (Connection conn = this.connect();
             Statement stmt = conn.createStatement();
             ResultSet rs = stmt.executeQuery(sql)) {
